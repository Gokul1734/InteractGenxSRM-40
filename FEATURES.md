...
- Desktop: Full-width single column layout
...
- Sessions display list of connected users with their roles (host/viewer)
...
- Removed "Site Compatibility" and "Tracked Actions" panels for cleaner UI
